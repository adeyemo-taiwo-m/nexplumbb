...
const initialArtisans: Artisan[] = [
  ...
  },
  {
    ...
    priceMin: 12000,
    priceMax: 22000,
    badges: ['id_verified', 'certified', 'trade_tested'],
    isAvailable: true,
    isOnline: true,
    bio: 'Professional tiling specialist. Floor tiling, wall tiling, bathroom renovations, and marble fittings. Over 6 years serving commercial and residential estates.',
    skills: ['Ceramic Tiling', 'Marble Installation', 'Wall Grouting', 'Bathroom Renovations'],
    portfolio: [
      { url: 'https://images.unsplash.com/photo-1502005229762-fc1b2b812ca5?w=500&auto=format&fit=crop', caption: 'Polished bathroom tiles', tag: 'After' }
    ],
    experience: '5-10 years',
    ...
    bvn: '225******34',
    nin: '56789012345',
    earningsAvailable: 15000,
    earningsPending: 0,
    earningsAllTime: 210000,
    isVerified: true,
    verificationStatus: 'verified',
    ninStatus: 'verified',
    bvnStatus: 'verified',
  ...
  },
  {
    ...
    name: 'Grace Benson',
    phone: '08055551111',
    email: 'grace.plumbing@gmail.com',
    trade: 'Plumbing',
    rating: 4.5,
    reviewCount: 14,
    jobCount: 30,
    ...
    isAvailable: true,
    isOnline: true,
    bio: 'Certified professional plumber with a passion for precise installations. Specializing in water filtration, kitchen repairs, and pressure pumps. Fast delivery and high-efficiency fixes.',
    skills: ['Water Filtration', 'Kitchen Plumbing', 'Pump Repair', 'Water Auditing'],
    portfolio: [],
    experience: '3-5 years',
  ...
  },
  {
    ...
    name: 'Kelechi Amadi',
    phone: '08022223333',
    email: 'kelechi.electrics@yahoo.com',
    trade: 'Electrical',
    rating: 4.8,
    reviewCount: 20,
    jobCount: 65,
    ...
    isAvailable: true,
    isOnline: true,
    bio: 'Expert residential and commercial electrician based in Lekki. Specializing in solar inverter installations, conduit wiring, and smart home setups.',
    skills: ['Inverter Installation', 'Solar Setup', 'Conduit Wiring', 'Smart Switches'],
    portfolio: [],
    experience: '5-10 years',
    ...
    bvn: '227******56',
    nin: '78901234567',
    earningsAvailable: 25000,
    earningsPending: 0,
    earningsAllTime: 310000,
    isVerified: true,
    verificationStatus: 'verified',
    ninStatus: 'verified',
    bvnStatus: 'verified',
  ...
  },
  {
    ...
    name: 'Olumide Bakare',
    phone: '09012344321',
    email: 'olumide.woodworks@gmail.com',
    trade: 'Carpentry',
    rating: 4.4,
    reviewCount: 10,
    jobCount: 28,
    ...
    priceMin: 8000,
    priceMax: 18000,
    badges: ['id_verified', 'trade_tested'],
    isAvailable: true,
    isOnline: false,
    bio: 'Reliable mainland carpenter specializing in roof carpentry, door frames, lock installations, and structural repairs. Neat, budget-friendly woodwork.',
    skills: ['Lock Installation', 'Door Frames', 'Roof Framing', 'Decking'],
    portfolio: [],
    experience: '3-5 years',
    bankName: 'Wema Bank',
  ...
  },
  {
    ...
    name: 'Chioma Nnaji',
    phone: '08177778888',
    email: 'chioma.finishes@gmail.com',
    trade: 'Painting',
    rating: 4.9,
    reviewCount: 18,
    jobCount: 50,
    ...
    isAvailable: true,
    isOnline: true,
    bio: 'Professional female painter offering screeding, wallpapering, structural painting, and detailed finishing. Clean work and color consultations.',
    skills: ['Wall Painting', 'Screeding', 'Wallpaper Application', 'Color Consultation'],
    portfolio: [],
    experience: '5-10 years',
    bankName: 'Union Bank',
  ...
  },
  {
    ...
    isAvailable: true,
    isOnline: false,
    bio: 'Premium tile installer. Expert in porcelain, mosaic, granite, and interlocking brick installations for kitchens, pools, and driveways.',
    skills: ['Porcelain Tiles', 'Mosaic Fitting', 'Granite Installation', 'Interlocking Bricks'],
    portfolio: [],
    experience: '5-10 years',
    bankName: 'Access Bank',
    ...
    bvn: '230******89',
    nin: '01234567890',
    earningsAvailable: 8000,
    earningsPending: 0,
    earningsAllTime: 140000,
    isVerified: true,
    verificationStatus: 'verified',
    ninStatus: 'verified',
    bvnStatus: 'verified',
  ...
  },
  {
    ...
    name: 'Abubakar Bello',
    phone: '08044445555',
    email: 'abubakar.plumb@gmail.com',
    trade: 'Plumbing',
    rating: 4.7,
    reviewCount: 25,
    jobCount: 88,
    ...
    isAvailable: true,
    isOnline: true,
    bio: 'Specialist in main-line pipe plumbing, borehole pump systems, overhead tank repairs, and sewage layout fittings. Swift response in Yaba and Ebute Metta.',
    skills: ['Borehole Setup', 'Tank Repair', 'Sewage Layout', 'Piping Fitting'],
    portfolio: [],
    experience: '5-10 years',
    ...
    bvn: '231******90',
    nin: '12345678902',
    earningsAvailable: 18500,
    earningsPending: 0,
    earningsAllTime: 260000,
    isVerified: true,
    verificationStatus: 'verified',
    ninStatus: 'verified',
    bvnStatus: 'verified',
  ...
  },
  {
    ...
    isAvailable: true,
    isOnline: false,
    bio: 'Experienced electrician specialized in domestic electrical safety, earth wiring, light fixtures, ceiling fan setups, and general DB audits.',
    skills: ['Safety Auditing', 'Ceiling Fan Setup', 'Light Fixtures', 'Earth Wiring'],
    portfolio: [],
    experience: '3-5 years',
    bankName: 'Zenith Bank',
