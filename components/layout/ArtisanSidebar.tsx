  ...
  return (
    <aside className="w-60 h-screen fixed left-0 top-0 bottom-0 bg-navy text-white flex flex-col z-30 border-r border-white/5 select-none">
      ...
      <div className="h-16 px-6 border-b border-white/10 flex items-center">
        <Link href="/" className="font-display font-bold text-[20px] tracking-tight">
          Nex<span className="text-orange">Plumb</span> <span className="text-[11px] font-mono text-slate bg-white/10 px-1.5 py-0.5 rounded ml-1 uppercase">Artisan</span>
        </Link>
      </div>
